...
if (isset($_POST['submit'])) {
    ...
    if (password_verify($cpassword, $hashedPassword)) {
        $select_admin = $conn->prepare("INSERT INTO `admin` (email, password) VALUES(?,?)");
        $select_admin->execute([$email, $hashedPassword]);
...
<nav>
   ...
   <div class="adminc">
      ...
      <form  method="post">
         ...
         <div class="form-group">
            <input type="submit" name="submit" value="REGISTER" required class="submit" />
         </div>
      </form>
   </div>
</body>
